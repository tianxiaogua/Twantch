...
#define SW_SHT30_Pin GPIO_PIN_14
#define SW_SHT30_GPIO_Port GPIOB

#define SHT30_POWER_ON()	  HAL_GPIO_WritePin(GPIOB, SW_SHT30_Pin, GPIO_PIN_SET)
#define SHT30_POWER_OFF()	  HAL_GPIO_WritePin(GPIOB, SW_SHT30_Pin, GPIO_PIN_RESET)

#define	SHT30_ADDR_WRITE	0x44<<1         //10001000
#define	SHT30_ADDR_READ		(0x44<<1)+1	    //10001011

#define	SHT30_MAX_TIMEOUT	0xFFFF
