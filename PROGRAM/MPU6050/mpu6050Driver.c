...
void read_all(void)
{
	...
	GUA_LOGI("acc is  x %d y %d z %d   x%.1f g,y%.1f g,z%.1f g\t",aacx,aacy,aacz,
																																	(float)(aacx)/lingmin,
																																	(float)(aacy)/lingmin,
																																	(float)(aacz)/lingmin
																																	);
	...
	GUA_LOGI("tuoluo is  x %d y %d z %d   x%.1f ,y%.1f ,z%.1f \n",tolx,toly,tolz,
																																	(float)(tolx)/tuol,
																																	(float)(toly)/tuol,
																																	(float)(tolz)/tuol
																																	);
