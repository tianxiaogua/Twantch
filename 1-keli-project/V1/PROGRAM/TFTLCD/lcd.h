...
void LCD_ShowIntNum(u16 x,u16 y,long num,u8 len,u16 fc,u16 bc,u8 sizey);//显示整数变量
void LCD_ShowIntNum1(u16 x,u16 y,u16 num,u8 len,u16 fc,u16 bc,u8 sizey);//显示整数变量
