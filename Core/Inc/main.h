...
/* Private defines -----------------------------------------------------------*/
#define BLE_KEY_Pin LL_GPIO_PIN_1
#define BLE_KEY_GPIO_Port GPIOC
#define BLE_REST_Pin LL_GPIO_PIN_2
